...
typedef struct __mccpacket {
  ...
  nx_uint8_t seq_num;           // Sequence number - these are continuous, e.g.
                                // C = 3 produces frames [0,1,2],[3,4,5] in bursts of 3
  ...
  nx_uint8_t burst_num;  // The sequence number of a burst e.g.
                         // if C = 3, frames with burst_num =  [0,1,2],[0,1,2],[0,1,2] produced
